...
# named volume (/apps-dev/talk_content_browser).
#
...
# first (output goes into talk_content_browser/js/).
#
# Usage: ./sync-app.sh

set -e

APP_DIR="$(dirname "$0")/talk_content_browser"
CONTAINER="nextcloud_app"
DEST="/apps-dev/talk_content_browser"
